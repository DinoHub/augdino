...
def test_background_noise(num_times=1000):
    ...
    augment = AddBackgroundNoise(local_path = '/home/daniel/datasets/processed/wham_noise/tr', p = 1.0,)
...
def test_reverb_small(num_times=1000):
    ...
    augment = Reverb(max_reverb=20, max_damp_factor=20, max_room_size=20, p=1.0)
    tensor = torch.rand([1, 16000])
